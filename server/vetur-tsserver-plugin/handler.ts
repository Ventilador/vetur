...
import {} from '../shared/moves';
import { TextSpan, ScriptKind, server } from 'typescript/lib/tsserverlibrary';
...
export class Handler {
  ...
  getOccurrencesAtPosition(
    ...
    return this._languageService.getOccurrencesAtPosition(fileName, offset);
  }
  ...
  getDefinitionAtPosition(;
    @Reviver(Thru) fileName: string,;
    @Reviver(F64) offset: number;
  ): { fileName: string; textSpan: TextSpan; }[]; {
